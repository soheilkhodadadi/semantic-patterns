...
- `labcore`: ~95-100%
- `director`: ~90-95%
- `ai_washing` active member migration: ~78-86%
- full clean final lab structure: ~74-80%
...
- the active sentence-pool data lane is now canonical
- the remaining active pressure is now concentrated in active-window
