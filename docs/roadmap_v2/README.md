# Roadmap V2 Workspace

This folder is the public-safe workspace for the post-preliminary pivot.

Use it for:
- engine-boundary documents
- source-of-truth maps
- public-safe roadmap reviews
- FilingLens proof planning
- other strategy notes that are safe to keep in the repo

Do **not** use this folder for:
- partner-confidential notes
- interview prep that names private organizations or non-public terms
- NDA-bound materials
- negotiation notes or business-development notes you would not want in a public repo
...
Suggested first local-private artifacts:
...
- `docs/roadmap_v2/migration_round_d_ai_washing_artifact_index_v1.md`
...
- `docs/roadmap_v2/fresh_authority_comparison_v6.md`
- `docs/roadmap_v2/fresh_authority_comparison_v7.md`
- `docs/roadmap_v2/fresh_authority_comparison_v8.md`
...
- `docs/roadmap_v2/batched_execution_queue_v4.md`
- `docs/roadmap_v2/batched_execution_queue_v5.md`
...
- `docs/roadmap_v2/restructure_parallel_protocol_v1.md`
- `docs/roadmap_v2/restructure_parallel_protocol_v2.md`
- `docs/roadmap_v2/restructure_short_term_rounds_v1.md`
- `docs/roadmap_v2/restructure_short_term_rounds_v2.md`
