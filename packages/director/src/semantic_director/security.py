"""Director-facing security helpers with package-owned contracts."""
...
from semantic_labcore.security import ensure_api_key_if_enabled as _ensure_api_key_if_enabled
