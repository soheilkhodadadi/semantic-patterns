...
class StakeholderAlignmentSpec(DeterministicModel):
    schema_version: str = Field(default=ROADMAP_SCHEMA_VERSION)
    source_artifact: str
    active_development_scope: str
    publication_target_scope: str
    desired_horizon: str
    methodology_hard_gates: list[str] = Field(default_factory=list)
...
__all__ = [
    ...
    "PlaybookUsageSummary",
    "StakeholderRequirementSpec",
    "StakeholderAlignmentSpec",
    "MethodologyRequirementSpec",
    "MethodologyMeasureSpec",
    "MethodologyAlignmentSpec",
    "ApiAssistivePromptSpec",
    "ApiAssistiveSmokeSpec",
    "ApiAssistivePolicy",
    "TaskSpec",
    "PhaseSpec",
    "IterationSpec",
