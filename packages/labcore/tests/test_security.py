...
def test_generic_api_key_validator(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert (ok, message) == (False, "missing")
    ...
    assert (ok, message) == (False, "invalid")
    ...
    assert (ok, message) == (True, "present")
