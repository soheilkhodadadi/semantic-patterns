...
def main() -> None:
    ...
    if "table7c_mismatch_determinants_reduced" in selected:
        _write_text(
            output_dir / "table_7c_mismatch_determinants_reduced_prelim_v1.md",
            _render_row_matrix_payload_markdown(
                summarize_table_7c_mismatch_determinants_reduced(args.panel)
            ),
        )

    if "table7d_mismatch_intensity_reduced" in selected:
        _write_text(
            output_dir / "table_7d_mismatch_intensity_reduced_prelim_v1.md",
            _render_row_matrix_payload_markdown(
                summarize_table_7d_mismatch_intensity_reduced(args.panel)
            ),
        )
